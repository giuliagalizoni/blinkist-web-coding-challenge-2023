...
},{"./bundle-url":"../../../.nvm/versions/node/v16.13.1/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/styles.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../.nvm/versions/node/v16.13.1/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/analytics-api.js":[function(require,module,exports) {
"use strict";
...
var signUpLink = document.getElementById('sign-up-link'); // Randomly assigning control variant or test variant and storing it in localStorage to guarantee that the user always sees the same variation even if the page is closed or reloaded
...
countViews();
countClicks(); // Tracking Page View

(0, _analyticsApi.trackPageview)("URL: ".concat(document.URL, ", AB-test: ").concat(window.localStorage.getItem('abStorage'), ", numberOfViews: ").concat(window.localStorage.getItem('pageCount'))); // Tracking Event

(0, _analyticsApi.trackEvent)("Event: \"click\", URL: ".concat(document.URL, ", clicks: ").concat(window.localStorage.getItem('clickCount') ? window.localStorage.getItem('clickCount') : 0));
window.localStorage.clear();
},{"./styles.css":"src/styles.css","./analytics-api.js":"src/analytics-api.js"}],"../../../.nvm/versions/node/v16.13.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nvm/versions/node/v16.13.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.js"], null)
